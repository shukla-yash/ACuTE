...
for i in range(len(curriculum_shifted_reward_arr)):
	if curriculum_shifted_reward_arr[i] > 1100:
		curriculum_shifted_reward_arr[i] = 600
...
# plt.plot(data_final_average[::20], label = 'learning from scratch')
plt.xlabel('Episodes')
plt.ylabel('Average rewards')
plt.legend()
# plt.show()
plt.savefig("Low_Fidelity_Automated_Curriculum")
