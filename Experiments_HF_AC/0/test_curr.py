...
if __name__ == "__main__":
	...
	width_array = [1.4,2.0,2.0,2.0]
	height_array = [1.6,1.8,2.0,2.0]
	no_trees_array = [2,0,1,3]
	no_rocks_array = [0,0,1,2]
	crafting_table_array = [0,1,1,1]
	starting_trees_array = [0,2,1,0]
	starting_rocks_array = [0,1,0,0]
	type_of_env_array = [1,0,2,2]
