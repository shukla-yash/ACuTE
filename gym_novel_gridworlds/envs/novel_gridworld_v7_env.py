...
class NovelGridworldV7Env(gym.Env):
    ...
    def __init__(self):
        ...
        self.env_name = 'NovelGridworld-v7'
        self.map_width = 20
        self.map_height = 20
        ...
        high = np.array([self.max_beam_range] * (len(self.items_lidar) * self.num_beams) + [5] * len(
    ...
    def reset(self, map_width=None, map_height=None, items_id=None, items_quantity=None, initial_inventory = None, goal_env = None):
