...
if __name__ == "__main__":
	...
	for final_env in range(beam_search_width):
		...
		final_status = True
		env_id = 'NovelGridworld-v0'
		env = gym.make(env_id, map_width = 12, map_height = 12, items_quantity = {'tree': 4, 'rock': 2, 'crafting_table': 1, 'pogo_stick':0},
			initial_inventory = {'wall': 0, 'tree': 0, 'rock': 0, 'crafting_table': 0, 'pogo_stick':0}, goal_env = 2, is_final = final_status)
